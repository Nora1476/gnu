...
<![endif]-->
    ...
    add_stylesheet('<link rel="stylesheet" href="' . G5_JS_URL . '/slick/slick.css">', 0);
    add_stylesheet('<link rel="stylesheet" href="' . G5_JS_URL . '/slick/slick-theme.css">', 0);
    ...
    add_javascript('<script src="' . G5_JS_URL . '/vendor/modernizr.custom.min.js"></script>', 0); //mansonry
    add_javascript('<script src="' . G5_JS_URL . '/vendor/jquery-1.10.2.min.js"></script>', 0);
    add_javascript('<script src="' . G5_JS_URL . '/vendor/masonry.pkgd.min.js"></script>', 0);
    add_javascript('<script src="' . G5_JS_URL . '/vendor/imagesloaded.pkgd.min.js"></script>', 0);
    add_javascript('<script src="' . G5_JS_URL . '/slick/slick.min.js"></script>', 0); //slick_slider
    add_javascript('<script src="' . G5_JS_URL . '/aos/aos.js"></script>', 0); //aos
    add_javascript('<script src="' . G5_JS_URL . '/c_common.js"></script>', 0);
    add_javascript('<script src="' . G5_JS_URL . '/c_main.js"></script>', 0);
